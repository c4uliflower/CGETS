    ...
    public Main7() {
        ...
        btnNewButton.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		Events7 events7 = new Events7();
        		events7.setVisible(true);
        		setVisible(false);
        	}
        });
        ...
        btnNewButton_3.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		Members7 members7 = new Members7();
        		members7.setVisible(true);
        		setVisible(false);
        	}
        });
        ...
        btnNewButton_4.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		Archives7 archives7 = new Archives7();
        		archives7.setVisible(true);
        		setVisible(false);
        	}
        });
        ...
        btnNewButton_6.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		Attendance7 attendance7 = new Attendance7();
        		attendance7.setVisible(true);
        		setVisible(false);
        	}
        });

...
public class Main extends JFrame {
   ...
   /* ARCHIVES
    ...
    public Main() {
    	...
    	ImageIcon Iconclearance = new ImageIcon("C:\\Users\\PC01\\eclipse-workspace\\kean\\src\\CGETS\\clearance.png");
    	...
    	panel2.setBackground(new Color(38, 99, 18));
    	getContentPane().add(panel2);

        JButton btnNewButton = new JButton("EVENTS");
        btnNewButton = new JButton();
        btnNewButton.setBounds(425, 100, 175, 175);
        ...
        btnNewButton.setFont(new Font("PixelMplus10", Font.BOLD, 11));
        contentPane.add(btnNewButton);

        JButton btnNewButton_1 = new JButton("FEES");
        btnNewButton_1 = new JButton();
        btnNewButton_1.setBounds(690, 100, 175, 175);
        btnNewButton_1.setOpaque(false);
        btnNewButton_1.setContentAreaFilled(false);
        btnNewButton_1.setBorderPainted(false);
        btnNewButton_1.setFocusable(false);
        btnNewButton_1.setIcon(Iconfees);
        ...
        btnNewButton_1.setFont(new Font("PixelMplus10", Font.BOLD, 11));
        contentPane.add(btnNewButton_1);

        JButton btnNewButton_2 = new JButton("CLEARANCE");
        btnNewButton_2 = new JButton();
        btnNewButton_2.setBounds(940, 100, 175, 175);
        btnNewButton_2.setOpaque(false);
        btnNewButton_2.setContentAreaFilled(false);
        btnNewButton_2.setBorderPainted(false);
        btnNewButton_2.setFocusable(false);
        btnNewButton_2.setIcon(Iconclearance);
        ...
        btnNewButton_2.setFont(new Font("PixelMplus10", Font.BOLD, 11));
        contentPane.add(btnNewButton_2);

        JButton btnNewButton_3 = new JButton("MEMBERS");
        btnNewButton_3 = new JButton();
        btnNewButton_3.setBounds(425, 286, 175, 175);
        ...
        btnNewButton_3.setFont(new Font("PixelMplus10", Font.BOLD, 11));
        contentPane.add(btnNewButton_3);
        
        JButton btnNewButton_4 = new JButton("ARCHIVE\r\n");
        btnNewButton_4 = new JButton();
        btnNewButton_4.setBounds(690, 305, 175, 175);
        ...
        btnNewButton_4.setFont(new Font("PixelMplus10", Font.BOLD, 11));
        ...
        btnNewButton_6.setBounds(940, 305, 175, 175);
        ...
        lblNewLabel = new JLabel("Welcome to the");
        ...
        lblNewLabel_3 = new JLabel("Copyright © 2023 Group 3. All rights reserved.");

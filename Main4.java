...
public class Main4 extends JFrame {
    ...
    public Main4() {
        ...
        btnNewButton_3.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		Members4 members4 = new Members4();
        		members4.setVisible(true);
        		setVisible(false);
        	}
        });
        ...
        btnNewButton_4.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		Archives4 archives4 = new Archives4();
        		archives4.setVisible(true);
        		setVisible(false);
        	}
        });
        ...
        btnNewButton_6.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		Attendance4 attendance4 = new Attendance4();
        		attendance4.setVisible(true);
        		setVisible(false);
        	}
        });

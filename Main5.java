    ...
    public Main5() {
        ...
        btnNewButton.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		Events5 events5 = new Events5();
        		events5.setVisible(true);
        		setVisible(false);
        	}
        });
        ...
        btnNewButton_3.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		Members5 members5 = new Members5();
        		members5.setVisible(true);
        		setVisible(false);
        	}
        });
        ...
        btnNewButton_4.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		Archives5 archives5 = new Archives5();
        		archives5.setVisible(true);
        		setVisible(false);
        	}
        });
        ...
        btnNewButton_6.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		Attendance5 attendance5 = new Attendance5();
        		attendance5.setVisible(true);
        		setVisible(false);
        	}
        });

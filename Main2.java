...
public class Main2 extends JFrame {
    ...
    public Main2() {
        ...
        btnNewButton_1.setBounds(691, 100, 175, 175);
        ...
        btnNewButton_1.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		Payments2 payments2 = new Payments2();
        		payments2.setVisible(true);
        		setVisible(false);
        	}
        });
        ...
        btnNewButton_3.setBounds(940, 100, 175, 175);
        ...
        btnNewButton_3.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		Members2 members2 = new Members2();
        		members2.setVisible(true);
        		setVisible(false);
        	}
        });
        ...
        btnNewButton_6.setBounds(815, 304, 175, 175);
